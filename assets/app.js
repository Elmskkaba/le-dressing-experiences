(function(){
  var sel='.u-card, .detail-grid, .edition-row, .c-card, .gallery .g-item, .gallery-4 .g-item, .ex-mosaic img, .f-grid, .intro-grid, .ex-grid > div, .map-ph, .cta-band, .editorial-intro > *, .section-line-head > *, .fashion-tile, .signature-panel > *, .founder-image-wrap, .founder-editorial-copy > *, .closing-editorial-inner > *, .uv4-statement > *, .uv4-chapter-head > *, .uv4-mode-main, .uv4-mode-copy, .uv4-mode-detail, .uv4-experience-copy, .uv4-event-landscape, .uv4-event-portrait, .uv4-image-head > *, .uv4-image-main, .uv4-image-secondary, .uv4-image-note, .uv4-hospitality-copy > *, .uv4-hospitality-visual, .uv4-manifesto-inner > *, .evt-invite-card, .evt-programme-list li, .evt-photo-a, .evt-photo-b, .evt-card-a, .evt-card-b, .evt-community-copy > *, .evt-community-photo, .evt-ticket, .evt-rsvp-seal, .evt-rsvp h2, .evt-rsvp p, .evt-rsvp-actions, .fv6-manifesto-grid > *, .fv6-section-head > *, .fv6-time-row, .fv6-method-media, .fv6-method-copy > *, .fv6-pillars-head > *, .fv6-pillar, .fv6-profile-heading > *, .fv6-profile-info > *, .fv6-closing-inner > *, .cv7-intro-grid > *, .cv7-section-head > *, .cv7-service, .cv7-request-aside > *, .cv7-form, .cv7-note-inner > *';
